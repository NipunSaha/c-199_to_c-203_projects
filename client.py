...
class GUI:
      ...
      def layout(self,name):
            ...
            self.line.place(relwidth=1,relheight=0.01,rely=0.07)
            ...
            self.buttonMsg.place(rely=0.008,relx=0.77,relheight=0.06,relwidth=0.22)

            self.textCons.config(cursor="arrow")
            
            scrollbar = Scrollbar(self.textCons)
            scrollbar.place(relx=0.971,relheight=1)
